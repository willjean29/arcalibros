  ...
  return (
    ...
    <div className="quiz-editor-navbar">
      ...
      <div className="quiz-editor-buttons">
        <div id="1" className={`${selectedOption === SelectionType.BANK ? 'btn-new-question active': 'btn-new-question'}`} onClick={handleSelection}>Banco de evaluaciones</div>
        <div id="2" className={`${selectedOption === SelectionType.NEW ? 'btn-new-question active': 'btn-new-question'}`} onClick={handleSelection}>Nueva evaluación</div>
      </div>
    </div>
    </div>
  );
